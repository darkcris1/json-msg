export const TYPE_KEY = "$$jmType->"; //Unique Type Obj Key
export const JM_ARRAY_MSG_KEY = "__jmArrayMsg"; //Unique Type Obj Key
...
export const isJMSameas = (obj) => !!obj && obj.config.type === "sameas";
